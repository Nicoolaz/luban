...
public class DeclaringTypeNameVisitorTabtoy : DecoratorFuncVisitor<string>
{
    public static DeclaringTypeNameVisitorTabtoy Ins { get; } = new();

    protected virtual ITypeFuncVisitor<string> UnderlyingVisitor => UnderlyingDeclaringTypeNameVisitorTabtoy.Ins;
