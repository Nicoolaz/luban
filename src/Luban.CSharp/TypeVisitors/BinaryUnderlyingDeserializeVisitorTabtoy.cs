...
public class BinaryUnderlyingDeserializeVisitorTabtoy : ITypeFuncVisitor<string, string, int, string>
{
    public static BinaryUnderlyingDeserializeVisitorTabtoy Ins { get; } = new();
    ...
    {
        string src = $"{type.DefBean.FullTypeName}.Deserialize{type.DefBean.Name}({bufName})";
