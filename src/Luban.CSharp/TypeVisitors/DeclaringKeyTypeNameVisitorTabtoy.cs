...
public class DeclaringKeyTypeNameVisitorTabtoy : DecoratorFuncVisitor<string>
{
    public static DeclaringKeyTypeNameVisitorTabtoy Ins { get; } = new();

    protected virtual ITypeFuncVisitor<string> UnderlyingVisitor => UnderlyingDeclaringKeyTypeNameVisitorTabtoy.Ins;
