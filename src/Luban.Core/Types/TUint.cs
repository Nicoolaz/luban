...
{
    public static TUint Create(bool isNullable, Dictionary<string, string> tags)
    {
        return new TUint(isNullable, tags);
    }

    public override string TypeName => "uint";

    private TUint(bool isNullable, Dictionary<string, string> tags) : base(isNullable, tags)
    {
    }
